...
import moa.classifiers.meta.DualEnsembleAccuracyUpdatedEnsembleBaggingBothExpAbstain;
import moa.core.Measurement;
import moa.core.ObjectRepository;
import moa.core.TimingUtils;
import moa.evaluation.ClassificationPerformanceEvaluator;
import moa.evaluation.LearningCurve1;
...
public class EvaluateInterleavedChunks extends MainTask {
	 ...
	 */
	public ClassOption streamOption = new ClassOption("stream", 's', "Stream to learn from.", InstanceStream.class,
	...
	/**
	 * Allows to define the maximum number of instances to test/train on (-1 =
	 * no limit).
	 */
	...
	protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
		...
		LearningCurve1 learningCurve = new LearningCurve1("learning evaluation instances");
